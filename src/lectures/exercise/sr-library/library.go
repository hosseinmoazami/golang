...
func printMemberAudit(member *Member) {
	for title, audit := range member.books {
		...
		fmt.Println(member.name, ":", title, ":", audit.checkIn.String(), "through", returnTime)
	}
}
...
func main() {
	...
	library.members["Hossein"] = Member{"Hossein", make(map[Title]LendAudit)}
	library.members["Hasti"] = Member{"Hasti", make(map[Title]LendAudit)}
	...
	member := library.members["Hossein"]
